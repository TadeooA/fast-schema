...
async function quickUltraTest() {
    ...
    const standardStringSchema = api_1.fast.string().email();
    const ultraStringSchema = api_1.fast.ultra.string().email();
    const extremeStringSchema = api_1.fast.ultra.extreme.string().email();
    ...
    const standardObjectSchema = api_1.fast.object({
        id: api_1.fast.string(),
        name: api_1.fast.string().min(2),
        email: api_1.fast.string().email(),
        age: api_1.fast.number().min(0).max(120)
    });
    const ultraObjectSchema = api_1.fast.ultra.object({
        id: api_1.fast.ultra.string(),
        name: api_1.fast.ultra.string().min(2),
        email: api_1.fast.ultra.string().email(),
        age: api_1.fast.ultra.number().min(0).max(120)
    });
    const extremeObjectSchema = api_1.fast.ultra.extreme.object({
        id: api_1.fast.ultra.extreme.string(),
        name: api_1.fast.ultra.extreme.string().min(2),
    ...
    const itemSchema = api_1.fast.ultra.object({
        id: api_1.fast.ultra.number(),
        name: api_1.fast.ultra.string(),
        active: api_1.fast.ultra.boolean()
    });
    const batchValidator = api_1.fast.ultra.batch(itemSchema);
    ...
    console.log('\n📊 Performance Metrics:');
    const metrics = api_1.fast.ultra.performance.getMetrics();
...
//# sourceMappingURL=test-ultra-performance.js.map