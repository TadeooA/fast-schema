    ...
    static async _loadWasmInternal() {
        try {
            ...
            imports = {
                './fast_schema_bg.js': {
                    __wbg_set_wasm: () => { },
                    __wbg_error_7534b8e9a36f1ab4: (ptr, len) => console.error('WASM Error'),
                    __wbg_error_785f3cbbddee182e: (ptr, len) => console.error('WASM Error'),
                    __wbg_log_7ff3e5f5d9bc8473: (ptr, len) => console.log('WASM Log'),
                    __wbg_new_8a6f238a6ece86ea: () => ({}),
                    __wbg_stack_0ed75d68575b0f3c: (ptr, len) => '',
                    __wbg_warn_3db133942ab6822e: (ptr, len) => console.warn('WASM Warning'),
                    __wbg_wbindgenthrow_4c11a24fca429ccf: (ptr, len) => { throw new Error('WASM throw'); },
